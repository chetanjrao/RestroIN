...
public class CuisinesGridAdapter extends BaseAdapter {

    private List<String> amenities;
    private Context context;

    public CuisinesGridAdapter(List<String> amenities, Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            AmenitiesView = inflater.inflate(R.layout.layout_cuisines_view, parent, false);
