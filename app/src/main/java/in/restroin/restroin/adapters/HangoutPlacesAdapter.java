...
public class HangoutPlacesAdapter extends RecyclerView.Adapter<HangoutPlacesAdapter.ViewHolder> {
    private List<HangoutRestaurants> popularRestaurants;
    private Context context;

    public HangoutPlacesAdapter(List<HangoutRestaurants> popularRestaurants, Context context){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView restaurant_name, price_for_two, restaurant_region, special_offer;
        ...
        public ViewHolder(View itemView){
            ...
            special_offer = (TextView) itemView.findViewById(R.id.special_offer);
    ...
    @NonNull
    @Override
    public HangoutPlacesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View popularRestaurantsView = LayoutInflater.from(context).inflate(R.layout.layout_hangouts_card, parent, false);
        return new ViewHolder(popularRestaurantsView);
    }

    @Override
    public void onBindViewHolder(@NonNull HangoutPlacesAdapter.ViewHolder holder, int position) {
        ...
        holder.special_offer.setText(popularRestaurants.get(position).getRestaurant_coupon_selected());
        ...
        holder.restaurant_id = popularRestaurants.get(position).getRestaurant_id();
    }
